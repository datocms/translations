module.exports = {
  ...
  'buildTrigger.spidering.hintWithLimit': `Everytime your site gets deployed, we'll respider it to get updated content. Your plan for this site limits the number of indexable pages to {limit}.`,
  ...
  'event.buildTrigger': `Build trigger`,
  'event.buildTrigger.noFilter': `No filter — this webhook will trigger for any build trigger`,
  'event.buildTrigger.only': `Trigger only with specific build triggers`,
  'event.environment.noFilter': `No filter — this webhook will trigger for any environment`,
  'event.environment.only': `Trigger only on specific environments`,
  'event.environmentType.only': `Trigger only if environment is primary/sandbox`,
  ...
  'limits.title': `Usage and plan limits`,
  ...
  'planUpgradeRequired.build_triggers.description': `You've reached the maximum number of build triggers your plan allows. If you're the project owner, please head over to your <a href="https://dashboard.datocms.com/">account dashboard</a> to upgrade the plan!`,
  'planUpgradeRequired.sandbox_environments.description': `You've reached the maximum number of environments your plan allows. If you're the project owner, please head over to your <a href="https://dashboard.datocms.com/">account dashboard</a> to upgrade the plan!`,
  'planUpgradeRequired.item_types.description': `You've reached the maximum number of models your plan allows to create. If you're the project owner, please head over to your <a href="https://dashboard.datocms.com/">account dashboard</a> to upgrade the plan!`,
  'planUpgradeRequired.items.description': `You've reached the maximum number of records your plan allows to create. If you're the project owner, please head over to your <a href="https://dashboard.datocms.com/">account dashboard</a> to upgrade the plan!`,
  'planUpgradeRequired.locales.description': `You've reached the maximum number of locales your plan allows. If you're the project owner, please head over to your <a href="https://dashboard.datocms.com/">account dashboard</a> to upgrade the plan!`,
  'planUpgradeRequired.mux_encoding_seconds.description': `You've reached the maximum video encoding limits of your project's current plan. If you're the project owner, please head over to your <a href="https://dashboard.datocms.com/">account dashboard</a> to upgrade the plan!`,
  'planUpgradeRequired.otp.description': `Two-factor authentication cannot be on the current plan. If you're the project owner, please head over to your <a href="https://dashboard.datocms.com/">account dashboard</a> to upgrade the plan!`,
  'planUpgradeRequired.plugins.description': `You've reached the maximum number of plugins your plan allows. If you're the project owner, please head over to your <a href="https://dashboard.datocms.com/">account dashboard</a> to upgrade the plan!`,
  'planUpgradeRequired.roles.description': `You've reached the maximum number of roles your plan allows to create. If you're the project owner, please head over to your <a href="https://dashboard.datocms.com/">account dashboard</a> to upgrade the plan!`,
  'planUpgradeRequired.uploadable_bytes.description': `You've reached the file storage limits of your project's current plan. If you're the project owner, please head over to your <a href="https://dashboard.datocms.com/">account dashboard</a> to upgrade the plan!`,
  'planUpgradeRequired.users.description': `You've reached the maximum number of users your plan allows to invite to the project. If you're the project owner, please head over to your <a href="https://dashboard.datocms.com/">account dashboard</a> to upgrade the plan!`,
