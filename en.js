module.exports = {
  ...
  'buildEvent.type.request_unprocessable': `Received an invalid webhook`,
  ...
  'buildTrigger.name.label': `Deployment Environment Name`,
  ...
  'buildTriggers.title': `Deployment status`,
  'button.default': `Send`,
  ...
  'form.webhook.entityTypeIds.build_trigger': `Build trigger IDs (separated by commas)`,
  'form.webhook.entityTypeIds.item': `Record IDs (separated by commas)`,
  'form.webhook.entityTypeIds.item_type': `Model API keys, or IDs (separated by commas)`,
  ...
  'limits.deployment_environments': `Build triggers`,
  'limits.deployment_environments.none': `No build triggers`,
  'limits.deployment_environments.unlimited': `Unlimited build triggers`,
  'limits.deployment_environments.usage': `{unformattedValue, plural, one { One build trigger } other { {value} build triggers } }`,
  ...
  'role.canEditFavicon': `Can modify project's favicon, global SEO settings and site indexing policy`,
  'role.canEditItemsCreatedBy': `Can edit records created by`,
  'role.canEditSchema': `Can modify models, fields and navigation bar`,
  'role.canEditSite': `Can modify project's languages, deployment, timezones and SSO settings`,
  'role.canManageAccessTokens': `Can manage API Tokens`,
  'role.canManageBuildTriggers': `Can manage build triggers`,
