module.exports = {
  ...
  'admin.auditLog.info':
    'Audit logs provide a record of changes and usage that help keep your organization secure and protect against misuse. Send data to a SIEM tool, watch for potential security issues, or build custom apps for better insight into how your company uses DatoCMS. <a target="_blank" href="https://www.datocms.com/docs/general-concepts/audit-logs">Read the docs &raquo;</a>',
  ...
  'itemType.workflow.hint':
    'Workflows enforce a precise state machine to bring a draft content up to the final publication',
...
<pre>{
  ...
  'validator.structured_text_links.title':
