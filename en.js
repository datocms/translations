module.exports = {
  ...
  'deploymentEnvironment.chooseAdapter': `Choose your deployment method`,
  ...
  'deploymentEnvironment.name.label': `Deployment Environment Name`,
  ...
  'form.editDeploymentEnvironmentForm.changeAdapter': `Change adapter`,
  ...
  'zeitSettings.changeLink': `Want to link to a different ZEIT project?`,
  'zeitSettings.createProject': `Create a new ZEIT project`,
  ...
  'zeitSettings.deployToZeit': `Authorize ZEIT`,
  'zeitSettings.link': `Project linked with {value}`,
  'zeitSettings.branch': `Specify here which GitHub branch you want to link to this deployment environment. When triggering a deploy the selected branch will be used by ZEIT to create a new build`,
  'zeitSettings.branch.hint': `If not specified, the project's 'master' branch will be used`,
  'zeitSettings.branch.placeholder': `master`,
  'zeitSettings.integrationStart': `Click the button to sign in to your ZEIT account and start the integration!`,
  'zeitSettings.loadingProjects': `Loading your ZEIT projects...`,
  'zeitSettings.noLink': `This DatoCMS project is currently linked to this ZEIT project:`,
  'zeitSettings.notLinkable': `Missing GitHub link - Please link this ZEIT project to a GitHub repository to integrate it with DatoCMS`,
  'zeitSettings.noProjects': `The ZEIT account you selected does not have any projects!`,
  'zeitSettings.projectCreated': `I&apos;ve created a new project, refresh the list`,
  'zeitSettings.projectSelect': `Select the ZEIT project you want to link to this DatoCMS project:`,
  ...
  'site.deployAdapters.recommended': `Recommended for JAMstack sites`,
  'site.deployAdapters.recommendedSub': `One-click setup, handles site building + CDN hosting`,
  'site.deployAdapters.other': `Other deployment methods`,
  'site.deployAdapters.otherSub': `Connect with your favourite CI and trigger a new build inside DatoCMS`,
  'site.deployAdapters.none': `None`,
  'site.deployAdapters.semaphore': `Semaphore`,
  'site.deployAdapters.travis': `Travis`,
  'site.deployAdapters.zeit': `ZEIT`,
