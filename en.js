module.exports = {
  ...
  'form.recordsPermissions.newRuleset.add': `Add new ruleset...`,
  'role.addItemType.multiple': `For model`,
  'role.addItemType.single': `For model`,
  'form.recordsPermissions.newRuleset.anyRecord': `For any record`,
  ...
  'role.select.action.all': `Perform all actions on records`,
  'role.select.action.delete': `Delete records`,
  'role.select.action.duplicate': `Create/duplicate records`,
  'role.select.action.editCreator': `Edit creator on records`,
  'role.select.action.none': `Perform any action on records`,
  'role.select.action.read': `View records`,
  'role.select.action.takeOver': `Take over records`,
  'role.select.action.unpublish': `Publish/unpublish records`,
  'role.select.action.update': `Edit records`,

  'role.select.creator.anyone': `Anyone`,
  'role.select.creator.negativeAnyone': `Anyone`,
  'role.select.creator.negativeRole': `Users under roles other than "{name}"`,
  'role.select.creator.negativeSelf': `Other users`,
  'role.select.creator.role': `Users under role "{name}"`,
  ...
  'role.upload.select.creator.negativeRole': `Users under roles other than "{name}"`,
  'role.upload.select.creator.negativeSelf': `Other users`,
  'role.upload.select.creator.role': `Users under role "{name}"`,
  ...
  'role.records.createdBy': `Created by:`,
  ...
  'role.uploads.createdBy': `Created by:`,
